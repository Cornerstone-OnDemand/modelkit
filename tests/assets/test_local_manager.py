...
def test_local_manager_no_versions(clean_env):
    ...
    with tempfile.TemporaryDirectory() as assets_dir:
        ...
        manager = AssetsManager(assets_dir=assets_dir)
...
def test_local_manager_with_versions(clean_env):
    with tempfile.TemporaryDirectory() as assets_dir:
...
def test_local_manager_with_fetch(clean_env):
    with tempfile.TemporaryDirectory() as assets_dir:
