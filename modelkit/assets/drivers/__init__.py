...
from modelkit.assets.drivers.s3 import S3SSMStorageDriver, S3StorageDriver
...
def settings_to_driver(driver_settings):
    ...
    if driver_settings.storage_provider == "s3ssm":
        return S3SSMStorageDriver(driver_settings.settings)
